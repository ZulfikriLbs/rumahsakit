...
/* @var $searchModel backend\models\search\TaSubBabSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Sub Bab Materi';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="ta-sub-bab-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Buat Sub Bab Baru','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Daftar Sub Bab',
