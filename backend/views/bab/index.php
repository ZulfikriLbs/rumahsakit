...
/* @var $searchModel backend\models\search\RefBabSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Bab Materi';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="ref-bab-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Buat Bab Baru','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Daftar Bab Materi',
